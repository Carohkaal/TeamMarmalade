...
namespace Rooting.WebApi.Client.Api
{
    ...
    public partial class WeatherForecastApi : IWeatherForecastApi
    {
        ...
        /// <returns></returns>
        public WeatherForecastApi(Rooting.WebApi.Client.Client.Configuration configuration)
        {
        ...
        public WeatherForecastApi(Rooting.WebApi.Client.Client.ISynchronousClient client, Rooting.WebApi.Client.Client.IAsynchronousClient asyncClient, Rooting.WebApi.Client.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Rooting.WebApi.Client.Client.ApiResponse<List<WeatherForecast>> localVarResponse = GetWeatherForecastWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;WeatherForecast&gt;</returns>
        public Rooting.WebApi.Client.Client.ApiResponse<List<WeatherForecast>> GetWeatherForecastWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "WeatherForecastApi.GetWeatherForecast";
        ...
        {
            Rooting.WebApi.Client.Client.ApiResponse<List<WeatherForecast>> localVarResponse = await GetWeatherForecastWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;WeatherForecast&gt;)</returns>
        public async System.Threading.Tasks.Task<Rooting.WebApi.Client.Client.ApiResponse<List<WeatherForecast>>> GetWeatherForecastWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Rooting.WebApi.Client.Client.RequestOptions localVarRequestOptions = new Rooting.WebApi.Client.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
...
namespace Rooting.WebApi.Client.Model
{
    ...
    public partial class WeatherForecast : IEquatable<WeatherForecast>, IValidatableObject
    {
        ...
        public WeatherForecast(DateTime date = default(DateTime), int temperatureC = default(int), string summary = default(string))
        {
            this.Date = date;
        ...
        /// </summary>
        [DataMember(Name = "temperatureC", EmitDefaultValue = true)]
        public int TemperatureC { get; set; }

        /// <summary>
        /// Gets or Sets TemperatureF
        /// </summary>
        [DataMember(Name = "temperatureF", EmitDefaultValue = true)]
