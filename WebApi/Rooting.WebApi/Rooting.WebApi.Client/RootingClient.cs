...
namespace Rooting.WebApi.Client.Api
{
    /// <summary>
    ...
    public interface IPlayerApiSync : IApiAccessor
    {
        ...
        Guid PlayerResetGamePost(int operationIndex = 0);
    ...
    public interface IPlayerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Guid> PlayerResetGamePostAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    {
        private Rooting.WebApi.Client.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Rooting.WebApi.Client.Client.Configuration.MergeConfigurations(
                Rooting.WebApi.Client.Client.GlobalConfiguration.Instance,
                new Rooting.WebApi.Client.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Rooting.WebApi.Client.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Rooting.WebApi.Client.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = Rooting.WebApi.Client.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public PlayerApi(Rooting.WebApi.Client.Client.Configuration configuration)
        {
            ...
            this.Client = new Rooting.WebApi.Client.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Rooting.WebApi.Client.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Rooting.WebApi.Client.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public PlayerApi(Rooting.WebApi.Client.Client.ISynchronousClient client, Rooting.WebApi.Client.Client.IAsynchronousClient asyncClient, Rooting.WebApi.Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Rooting.WebApi.Client.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Rooting.WebApi.Client.Client.ISynchronousClient Client { get; set; }
        ...
        public Rooting.WebApi.Client.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Rooting.WebApi.Client.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Guid</returns>
        public Guid PlayerResetGamePost(int operationIndex = 0)
        {
            Rooting.WebApi.Client.Client.ApiResponse<Guid> localVarResponse = PlayerResetGamePostWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Guid</returns>
        public Rooting.WebApi.Client.Client.ApiResponse<Guid> PlayerResetGamePostWithHttpInfo(int operationIndex = 0)
        {
            Rooting.WebApi.Client.Client.RequestOptions localVarRequestOptions = new Rooting.WebApi.Client.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
            ...
            localVarRequestOptions.Operation = "PlayerApi.PlayerResetGamePost";
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = this.Client.Post<Guid>("/Player/ResetGame", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Guid</returns>
        public async System.Threading.Tasks.Task<Guid> PlayerResetGamePostAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Rooting.WebApi.Client.Client.ApiResponse<Guid> localVarResponse = await PlayerResetGamePostWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Guid)</returns>
        public async System.Threading.Tasks.Task<Rooting.WebApi.Client.Client.ApiResponse<Guid>> PlayerResetGamePostWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Rooting.WebApi.Client.Client.RequestOptions localVarRequestOptions = new Rooting.WebApi.Client.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
            ...
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Guid>("/Player/ResetGame", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PlayerResetGamePost", localVarResponse);
                if (_exception != null)
...
namespace Rooting.WebApi.Client.Client
{
    /// <summary>
    ...
    internal class CustomJsonCodec : IRestSerializer, ISerializer, IDeserializer
    {
        ...
        {
            if (obj != null && obj is Rooting.WebApi.Client.Model.AbstractOpenAPISchema)
            {
                // the object to be serialized is an oneOf/anyOf schema
                return ((Rooting.WebApi.Client.Model.AbstractOpenAPISchema)obj).ToJson();
            }
            else
            {
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiClient()
        {
            _baseUrl = Rooting.WebApi.Client.Client.GlobalConfiguration.Instance.BasePath;
        }
        ...
        private ApiResponse<T> Exec<T>(RestRequest req, RequestOptions options, IReadableConfiguration configuration)
        {
            ...
            if (typeof(Rooting.WebApi.Client.Model.AbstractOpenAPISchema).IsAssignableFrom(typeof(T)))
            {
                try
                {
...
namespace Rooting.WebApi.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            string report = "C# SDK (Rooting.WebApi.Client) Debug Report:\n";
...
namespace Rooting.WebApi.Client.Model
{
    ...
    public partial class Player : IEquatable<Player>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "familyType", EmitDefaultValue = true)]
        ...
        public bool Equals(Player input)
        {
            ...
            return
                ...
                (
                    this.FamilyType == input.FamilyType ||
                    this.FamilyType.Equals(input.FamilyType)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.FamilyType.GetHashCode();
                if (this.Avatar != null)
                {
